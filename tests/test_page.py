...
with sync_playwright() as p:
    ...
    for style in ["initials", "pixel", "duck", "house", "marble", "bauhaus", "sunset", "terrain", "rings", "bloom"]:
    ...
    page.select_option("#astyle", "house")
    for _ in range(100):
        page.click("#newphoto")
    check("100 house renders without errors", not errors)
